...
(function ($) {
    ...
    function CloudZoom(jWin, opts) {
        ...
        this.init = function () {
            ...
            $mouseTrap.bind(m_move, this, function (e) { mx = (typeof (e.originalEvent.touches) != 'undefined') ? e.originalEvent.touches[0].pageX : e.pageX; my = (typeof (e.originalEvent.touches) != 'undefined') ? e.originalEvent.touches[0].pageY : e.pageY; }); $mouseTrap.bind(m_end, this, function (event) {
    ...
    $.fn.CloudZoom.defaults = { zoomWidth: 106, zoomHeight: 106, position: 'right', tint: false, tintOpacity: 0.5, lensOpacity: 0.5, softFocus: false, smoothMove: 3, showTitle: true, titleOpacity: 0.5, adjustX: 0, adjustY: 0 };
})(jQuery);
